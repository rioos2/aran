...
describe('User authenticate API', function() {
  it('returns the created user account', function(done) {
    request.post('/accounts')
      .send({"name": "megam1","email":"infof","first_name":"vino","last_name": "v","phone":"9994048897","api_key": "1234567890","password": "vino123","states":"safa","approval":"zfdgdg","suspend":"true","registration_ip_address": "","roles":["role/rios:superuser"]})
      .expect(200)
