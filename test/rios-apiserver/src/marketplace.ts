...
describe('Marketplace API', function() {
  ...
  it('returns the created Nginx', function(done) {
    request.post('/marketplaces')
      ...
      "category": "container","version": "1.13","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "nginx.png","description": "nginx [engine x] is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"80","rioos_sh_web_access_protocal":"http"},
      "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}},
      "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":80,"host_ip":"","host_port":80,"protocol":""}]}], "category": "container", "version": "1.13", "icon": "nginx.png", "description": "Nginx [engine x] is an HTTP and reverse proxy server, a mail proxy server, and a generic TCP/UDP proxy server, originally written by Igor Sysoev.",
      "status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Jenkins', function(done) {
    request.post('/marketplaces')
      ...
      "metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"8080","rioos_sh_web_access_protocal":"http"},"ports":[{"container_port":8080,     "host_ip":"","host_port":8080,"protocol":""}], "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}}}],
  ...
  it('returns the created Influxdb', function(done) {
    request.post('/marketplaces')
      ...
      "category": "container","version": "1.3.7","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "influxdb.png","description": "InfluxDB is a time series database built from the ground up to handle high write and query loads. InfluxDB is meant to be used as a backing store for any use case involving large amounts of timestamped data, including DevOps monitoring, application metrics, IoT sensor data, and real-time analytics. ","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"8086","rioos_sh_web_access_protocal":"http"},"lifecycle":{"probe": {"env": {}, "exec": [],
       "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},
       "ports":[{"container_port":8086, "host_ip":"","host_port":8086,"protocol":""}]}], "category": "container", "version": "1.3.7", "icon": "influxdb.png", "description": "InfluxDB is a time series database built from the ground up to handle high write and query loads. InfluxDB is meant to be used as a backing store for any use case involving large amounts of timestamped data, including DevOps monitoring, application metrics, IoT sensor data, and real-time analytics.","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
    ...
    request.post('/marketplaces')
      ...
      "category": "container","version": "2.0.18","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "orientdb.png","description": "OrientDB is the first Multi-Model Open Source NoSQL DBMS that combines the power of graphs and the flexibility of documents into one scalable, high-performance operational database. ","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"2424","rioos_sh_web_access_protocal":"http"},
      "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop":
      {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":2424, "host_ip":"","host_port":2424,"protocol":""}]}], "category": "container", "version": "2.0.18", "icon": "orientdb.png", "description": "OrientDB is the first Multi-Model Open Source NoSQL DBMS that combines the power of graphs and the flexibility of documents into one scalable, high-performance operational database.",
      "status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
    ...
    request.post('/marketplaces')
      ...
      "category": "container","version": "1.1.3","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "cockroachdb.png","description": "CockroachDB is an open source, survivable, strongly consistent, scale-out SQL database. ","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"26257","rioos_sh_web_access_protocal":"http"} ,
      "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []},
       "post_start": {"command": []}},"ports":[{"container_port":26257, "host_ip":"","host_port":26257,"protocol":""}]}], "category": "container", "version": "1.1.3", "icon": "cockroachdb.png", "description": "CockroachDB is an open source, survivable, strongly consistent, scale-out SQL database. ","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Rethinkdb', function(done) {
    request.post('/marketplaces')
      ...
      "map_type":"static/template/public_url" }},{"name": "postgres_data","volumes": {"host_path": "/var/lib/pgdata"},"volume_mounts": {"mount_path": "/var/lib/pgdata_inside_container"},"settingmap" : {"map_type":"static/template/public_url" }}],"version": "2.3.6","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "rethinkdb.png","description": "RethinkDB is an open-source, document database that makes it easy to build and scale realtime apps.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"8080","rioos_sh_web_access_protocal":"http"},
      "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
      "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":8080, "host_ip":"","host_port":8080,"protocol":""}]}],
  ...
  it('returns the created Apache', function(done) {
    request.post('/marketplaces')
      ...
      "category": "container","version": "2.4.33","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "apache.png","description": "PHP with Apache for Development (eg. with xdebug)","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"80","rioos_sh_web_access_protocal":"http"},"lifecycle":{"probe": {"env": {}, "exec": [],
      "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},
      "ports":[{"container_port":80, "host_ip":"","host_port":80,"protocol":""}]}], "category": "container", "version": "2.4.33", "icon": "apache.png", "description": "PHP with Apache for Development (eg. with xdebug) ","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created tyk', function(done) {
    request.post('/marketplaces')
      ...
      .set('Authorization', globalAny.bobo_bearer)
      .set('X-AUTH-RIOOS-EMAIL',globalAny.email)
      .send({"object_meta": {"name": "tyk","account": globalAny.account_id}, "plans": [ {"object_meta": {"name": "mongo","account": globalAny.account_id,
          "owner_references": [ {  "kind": "Package","api_version": "v1","name": "mongo","uid": globalAny.mongo_package_id,"block_owner_deletion": false }] },
         "category": "container", "version": "latest","characteristics": {"rioos_sh_market_image_extension": "tar.gz"}, "icon": "mongo.png", "description": "MongoDB document databases provide high availability and easy scalability.",
         "status": {"phase": "Ready" },"metadata": {"origin": "rioos_system"},"lifecycle": {"probe": { "env": {},"exec": [],"http_get": {"host": "",  "path": "","port": "", "scheme": ""},
         "tcp_socket": {  "host": "","port": "" }, "http_headers": {}},"pre_stop": {   "command": []},  "post_start": {"command": []} }, "ports": [{"container_port": 27017,"host_ip": "",
        "host_port": 27017,"protocol": ""  } ], "stateful_volumes": [{ "name": "mongo-data","volumes": {  "host_path": "/data/db"},   "volume_mounts": {  "mount_path": "/data/db"} }]},{"object_meta": {
        "name": "registry.rioos.xyz:5000/rioosredis", "account": globalAny.account_id,"owner_references": [ {"kind": "Package","api_version": "v1","name": "redis",  "uid": globalAny.redis_package_id,"block_owner_deletion": false}  ] },"category": "container",
         "version": "3.2.11","characteristics": {"rioos_sh_market_image_extension": "tar.gz"},"icon": "redis.png", "description": "Redis is an open source key-value store that functions as a data structure server.",
         "status": {  "phase": "Ready" },"metadata": {  "origin": "rioos_system"},"lifecycle": {"probe": { "env": {},"exec": [],"http_get": {"host": "",  "path": "","port": "",  "scheme": "" },
          "tcp_socket": {  "host": "","port": "" },"http_headers": {}  },"pre_stop": { "command": []},"post_start": { "command": []}},"ports": [  {   "container_port": 6379,"host_ip": "","host_port": 6379,"protocol": "TCP"},
          {"container_port": 16379,"host_ip": "","host_port": 16379, "protocol": "TCP"} ],"stateful_volumes": [{"name": "redis-data","volumes": {"host_path": "/var/lib/redis/redis-data"},"volume_mounts": {"mount_path": "/var/lib/redis/redis-data"}}]},
          {"object_meta": {"name": "tykio/tyk-gateway","account":globalAny.account_id,"owner_references": [{"kind": "Package","api_version": "v1", "name": "tyk-gateway","uid": globalAny.tyk_gateway_package_id,"block_owner_deletion": false}]},"category": "container","version": "latest","characteristics": {
          "rioos_sh_market_image_extension": "tar.gz"},"icon": "tyk_gateway.png","description": "Tyk API gateway.","status": {"phase": "Ready" },"metadata": {"origin": "rioos_system"},"lifecycle": {  "probe": { "env": {},"exec": [],"http_get": {"host": "",
          "path": "",  "port": "","scheme": ""},"tcp_socket": {  "host": "","port": ""}, "http_headers": {}},"pre_stop": {"command": []},"post_start": { "command": [] } },"ports": [ {"container_port": 8080,
          "host_ip": "", "host_port": 8080,"protocol": ""}], "envs": {"REDIGOCLUSTER_SHARDCOUNT": {"value": "128","required": "true","editable": ""  } },"stateful_volumes": [{ "name": "tyk-gateway-conf","volumes": {"host_path": "/tyk-gateway/tyk.standalone.conf"
          }, "volume_mounts": {  "mount_path": "/opt/tyk-gateway/tyk.conf"},"settingmap" : {"uri" : "https://marketplaces.rioos.xyz:6443/api/v1/marketplaces/966350214048833536/settingmap/tyk-gateway-conf", "uid" : "tyk_config_7825253252454",
          "rioos_binder": ["tykio/tyk-dashboard", "registry.rioos.xyz:5000/rioosredis"],"map_type":"template"}},{"name": "tyk_gateway","volumes": {"host_path": "/opt/tyk-gateway/apps" },"volume_mounts": {"mount_path": "/opt/tyk-gateway/apps"
        }}]  },{"object_meta": {"name": "tykio/tyk-dashboard","account": globalAny.account_id,"owner_references": [{"kind": "Package","api_version": "v1","name": "tyk-dashboard","uid": globalAny.tyk_dashboard_package_id,"block_owner_deletion": false }]}, "category": "container",
         "version": "latest","characteristics": {  "rioos_sh_market_image_extension": "tar.gz"}, "icon": "tyk_dashboard.png", "description": "Tyk API dashboard.","status": {"phase": "Ready"},"metadata": {"origin": "rioos_system",
        "rioos_sh_web_access_port": "3000","rioos_sh_web_access_protocal": "http"},"lifecycle": {"probe": {"env": {},"exec": [], "http_get": {"host": "","path": "","port": "", "scheme": ""},"tcp_socket": {"host": "",
        "port": ""},"http_headers": {}  },"pre_stop": { "command": []},"post_start": { "command": []  } },"ports": [{ "container_port": 3000,"host_ip": "","host_port": 3000, "protocol": ""} ],"stateful_volumes": [
        {"name": "tyk-dashboard-conf","volumes": {"host_path": "/opt/tyk-dashboard"},"volume_mounts": {"mount_path": "/opt/tyk-dashboard/tyk_analytics.conf"},"settingmap" : {"uri" : "https://marketplaces.rioos.xyz:6443/api/v1/marketplaces/966350214048833536/settingmap/tyk-dashboard-conf",
        "uid" : "tyk_analytics_config_86545115851", "rioos_binder": ["mongo", "registry.rioos.xyz:5000/rioosredis", "tykio/tyk-gateway"], "map_type":"template"}}],"envs": {"REDIGOCLUSTER_SHARDCOUNT": {"value": "128","required": "true","editable": ""} }},{"object_meta": {
        "name": "tykio/tyk-pump-docker-pub","account": globalAny.account_id,"owner_references": [{  "kind": "Package","api_version": "v1","name": "tyk-pump","uid": globalAny.tyk_pump_package_id,"block_owner_deletion": false}]},"category": "container","version": "latest",
         "characteristics": {  "rioos_sh_market_image_extension": "tar.gz"}, "icon": "tyk_pump.png", "description": "Tyk API pump.","status": {"phase": "Ready"},"metadata": {  "origin": "rioos_system" },"lifecycle": {  "probe": { "env": {},"exec": [],
         "http_get": { "host": "","path": "","port": "","scheme": "" }, "tcp_socket": {"host": "",  "port": "" },"http_headers": {} },"pre_stop": {"command": [] }, "post_start":
         {"command": []}},"ports": [],"stateful_volumes": [{"name": "tyk-pump-conf","volumes": {  "host_path": "/opt/tyk-pump/pump.conf"},   "volume_mounts": {  "mount_path": "/opt/tyk-pump/pump.conf"},   "settingmap" : {  "uri" : "https://marketplaces.rioos.xyz:6443/api/v1/marketplaces/966350214048833536/settingmap/tyk-pump-conf",
          "uid" : "pump_config_546165151555",  "rioos_binder": ["mongo", "registry.rioos.xyz:5000/rioosredis"],"map_type":"template"}  }], "envs": {"REDIGOCLUSTER_SHARDCOUNT": { "value": "128", "required": "true", "editable": "" }}}],
          "category": "container","version": "latest","icon": "tyk.png","description": "Tyk api management","status": {  "phase": "SyncPending" }})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created neo4j', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "3.3.1","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "neo4j.png","description": "Neo4j is a highly scalable, robust native graph database.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "7687",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":  {"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
      "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":7687, "host_ip":"","host_port": 7687,"protocol":""}]}], "category": "container", "version": "3.3.1",
  ...
  it('returns the created Couchdb', function(done) {
    request.post('/marketplaces')
      ...
      "description": "CouchDB is a database that uses JSON for documents, an HTTP API, & JavaScript/declarative indexing.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system",
      "rioos_sh_web_access_port": "5984","rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get":
      {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},
      "ports":[{"container_port":5984, "host_ip":"","host_port":5984,"protocol":""}]}], "category": "container", "version": "2.1.1", "icon": "couchdb.png", "description": "CouchDB is a database that uses JSON for documents, an HTTP API, & JavaScript/declarative indexing.","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Aerospike', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "3.15.0.2","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "aerospike.png","description": "Aerospike is reliable, high performance, distributed database optimized for flash and RAM.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "3000",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}},
       "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":3000, "host_ip":"","host_port":3000,"protocol":""}]}], "category": "container", "version": "3.15.0.2", "icon": "aerospike.png",
  ...
  it('returns the created Redis', function(done) {
    request.post('/marketplaces')
      ...
      .send({ "object_meta": { "name": "registry.rioos.xyz:5000/rioosredis", "account": globalAny.account_id }, "plans": [{ "object_meta": { "name": "registry.rioos.xyz:5000/rioosredis", "account": globalAny.account_id, "owner_references": [{ "kind": "Package", "api_version": "v1",
       ...
       "host_port": 80, "protocol": "" }] }], "category": "container", "version": "3.2.11", "icon": "redis.png", "description": "Redis is an open source key-value store that functions as a data structure server.", "status": { "phase": "SyncPending" } })
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Postgres', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "10.3","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "postgres.png","description": "The PostgreSQL object-relational database system provides reliability and data integrity.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "5432",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
      "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":5432, "host_ip":"","host_port":5432,"protocol":""}]}], "category": "container", "version": "10.3",
  ...
  it('returns the created Psitrax/Powerdns', function(done) {
    request.post('/marketplaces')
      ...
      .set('Authorization', globalAny.bobo_bearer)
      .set('X-AUTH-RIOOS-EMAIL',globalAny.email)
      .send({ "object_meta":{ "name":"registry.rioos.xyz:5000/rioospowerdns", "account":globalAny.account_id}, "plans":[{"object_meta":{"name":"registry.rioos.xyz:5000/rioospowerdns","account":globalAny.account_id,"owner_references":[{"kind":"Package", "api_version":"v1","name":"psitrax/powerdns", "uid":globalAny.powerdns_package_id,"block_owner_deletion":false}]},
      "category": "container","version": "4.0.3","characteristics" :{ "rioos_sh_market_image_extension": "tar.gz"},"icon" : "powerdns.png","description": "PowerDNS with all Backends. Alpine based. Auto DB initialization and graceful shutdown. ","status":{"phase":"SyncPending"},
      "metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"53","rioos_sh_web_access_protocal":"http"},"ports":[{"container_port":53,     "host_ip":"","host_port":53,"protocol":""}], "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}}}],
      "category": "container", "version": "4.0.3", "icon": "powerdns.png", "description": "PowerDNS with all Backends. Alpine based. Auto DB initialization and graceful shutdown.","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
        expect(res.body.object_meta.name).to.equal("registry.rioos.xyz:5000/rioospowerdns");
        expect(res.body.type_meta.kind).to.equal(globalAny.plan);
        expect(res.body.type_meta.api_version).to.equal(globalAny.version);
          done(err);
      });
  ...
  it('returns the created Fluentbit', function(done) {
    request.post('/marketplaces')
      ...
      "description": "Fluent Bit is an open source and multi-platform log forwarder tool which aims to be a generic Swiss knife for log collection and distribution.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "5170","rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get":
      {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start":
      {"command": []}},"ports":[{"container_port":5170, "host_ip":"","host_port":5170,"protocol":""}]}], "category": "container", "version": "0.12.15", "icon": "fluentbit.png", "description": "Fluent Bit is an open source and multi-platform log forwarder tool which aims to be a generic Swiss knife for log collection and distribution.",
      "status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Chronograf', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "1.3.10.0","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "chronograf.png","description": "Chronograf is a visualization tool for time series data in InfluxDB.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "8888",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
      "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":8888, "host_ip":"","host_port":8888,"protocol":""}]}], "category": "container", "version": "1.3.10.0",
  ...
  it('returns the created Cassandra', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "3.11.2","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "cassandra.png","description": "Apache Cassandra is an open-source distributed storage system.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "9042",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
       "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":9042, "host_ip":"","host_port":9042,"protocol":""},{"container_port":9142,
       "host_ip":"","host_port":9142,"protocol":""}]}], "category": "container", "version": "3.11.2", "icon": "cassandra.png", "description": "Apache Cassandra is an open-source distributed storage system.","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Voltdb', function(done) {
    request.post('/marketplaces')
      ...
      "description": "VoltDB is horizontally-scalable, in-memory SQL RDBMS designed for apps with extreme high throughput","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "8080","rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get":
      {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},
      "ports":[{"container_port":8080, "host_ip":"","host_port":8080,"protocol":""},{"container_port":3021, "host_ip":"","host_port":3021,"protocol":""},{"container_port":21211, "host_ip":"","host_port":21211,"protocol":""},{"container_port":21212,
      "host_ip":"","host_port":21212,"protocol":""}]}], "category": "container", "version": "7.8.2", "icon": "voltdb.png", "description": "VoltDB is horizontally-scalable, in-memory SQL RDBMS designed for apps with extreme high throughput","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Elasticsearch', function(done) {
    request.post('/marketplaces')
      ...
      "category": "container","version": "5.6.9","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "elasticsearch.png","description": "Elasticsearch is a powerful open source search and analytics engine that makes data easy to explore.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "9200","rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {},
      "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},
      "ports":[{"container_port":9200, "host_ip":"","host_port":9200,"protocol":""}]}], "category": "container", "version": "5.6.9", "icon": "elasticsearch.png", "description": "Elasticsearch is a powerful open source search and analytics engine that makes data easy to explore.","status":{"phase":"SyncPending"}})
      .expect(200)
      .end(function(err, res) {
  ...
  it('returns the created Kibana', function(done) {
    request.post('/marketplaces')
      ...
      "block_owner_deletion":false}]},"category": "container","version": "5.6.9","characteristics" :{"rioos_sh_market_image_extension": "tar.gz"},"icon" : "kibana.png","description": "Kibana gives shape to any kind of data structured and unstructured indexed in Elasticsearch.","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "5601",
      "rioos_sh_web_access_protocal": "http"},"lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""},
      "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}},"ports":[{"container_port":5601, "host_ip":"","host_port":5601,"protocol":""}]}], "category": "container", "version": "5.6.9",
