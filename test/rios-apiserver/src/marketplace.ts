...
describe('Marketplace API', function() {
  ...
  it('returns the created Jenkins', function(done) {
    request.post('/marketplaces')
      ...
      "metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"8080","rioos_sh_web_access_protocal":"http"},"ports":[{"container_port":8080,     "host_ip":"","host_port":0,"protocol":""}], "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}}}],
  ...
  it('returns the created tyk', function(done) {
    request.post('/marketplaces')
      ...
      .send({"object_meta": {"name": "tyk","account": globalAny.account_id}, "plans": [ {"object_meta": {"name": "mongo","account": globalAny.account_id,
        ...
        "host_port": 0,"protocol": ""  } ], "stateful_volumes": [{ "name": "mongo-data","volumes": {  "host_path": "/data/db"},   "volume_mounts": {  "mount_path": "/data/db"} }]},{"object_meta": {
        "name": "registry.rioos.xyz:5000/rioosredis", "account": globalAny.account_id,"owner_references": [ {"kind": "Package","api_version": "v1","name": "redis",  "uid": globalAny.redis_package_id,"block_owner_deletion": false}  ] },"category": "container",
         ...
         "status": {  "phase": "Ready" },"metadata": {  "origin": "rioos_system"},"lifecycle": {"probe": { "env": {},"exec": [],"http_get": {"host": "",  "path": "","port": "",  "scheme": "" },
          "tcp_socket": {  "host": "","port": "" },"http_headers": {}  },"pre_stop": { "command": []},"post_start": { "command": []}},"ports": [  {   "container_port": 6379,"host_ip": "","host_port": 0,"protocol": "TCP"},
          {"container_port": 16379,"host_ip": "","host_port": 0, "protocol": "TCP"} ],"stateful_volumes": [{"name": "redis-data","volumes": {"host_path": "/var/lib/redis/redis-data"},"volume_mounts": {"mount_path": "/var/lib/redis/redis-data"}}]},
          ...
          "host_ip": "", "host_port": 0,"protocol": ""}], "envs": {"REDIGOCLUSTER_SHARDCOUNT": {"value": "128","required": "true","editable": ""  } },"stateful_volumes": [{ "name": "tyk-gateway-conf","volumes": {"host_path": "/tyk-gateway/tyk.standalone.conf"
        ...
        "port": ""},"http_headers": {}  },"pre_stop": { "command": []},"post_start": { "command": []  } },"ports": [{ "container_port": 3000,"host_ip": "","host_port": 0, "protocol": ""} ],"stateful_volumes": [
  ...
  it('returns the created Psitrax/Powerdns', function(done) {
    request.post('/marketplaces')
      ...
      "metadata": {"origin": "rioos_system","rioos_sh_web_access_port":"53","rioos_sh_web_access_protocal":"http"},"ports":[{"container_port":53,     "host_ip":"","host_port":0,"protocol":""}], "lifecycle":{"probe": {"env": {}, "exec": [], "http_get": {"host": "", "path": "", "port": "", "scheme": ""}, "tcp_socket": {"host": "", "port": ""}, "http_headers": {}}, "pre_stop": {"command": []}, "post_start": {"command": []}}}],
