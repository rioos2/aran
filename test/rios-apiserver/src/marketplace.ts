...
describe('Marketplace API', function() {
  ...
  it('returns the created Psitrax/Powerdns', function(done) {
    request.post('/marketplaces')
      ...
      "description": "OrientDB is the first Multi-Model Open Source NoSQL DBMS that combines the power of graphs and the flexibility of documents into one scalable, high-performance operational database. ","status":{"phase":"SyncPending"},"metadata": {"origin": "rioos_system","rioos_sh_web_access_port": "2424","rioos_sh_web_access_protocal": "http"},  "lifecycle":{"probe": {"env": {}, "exec": [],
