...
impl Migratable for PlanProcedures {
    fn migrate(&self, migrator: &mut Migrator) -> Result<()> {
        ...
        migrator.migrate(
            "plansrv",
            r#"INSERT INTO plan_factory(name,description,tags,camp_version,origin,artifacts,services)VALUES ('1_virtualmachine_ubuntu', 'Ubuntu is a Debian-based Linux operating system.','{"linux", "ubuntu", "xenial", "14.04"}','1.2', 'vertice:2.0','{}','[{"name":"Trusty", "description":"Ubuntu is a Debian-based Linux operating system.
        ...
        migrator.migrate(
            "plansrv",
            r#"INSERT INTO plan_factory(name,description,tags,camp_version,origin,artifacts,services)VALUES ('2_application_java', 'The Apache Tomcat® software is an open source implementation of the Java Servlet, JavaServer Pages, Java Expression Language and Java WebSocket technologies.',
        ...
        migrator.migrate(
            "plansrv",
            r#"INSERT INTO plan_factory(name,description,tags,camp_version,origin,artifacts,services)VALUES ('3_webserver_apache', 'Apache is the most widely used web server software',
