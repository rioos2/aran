...
CREATE TABLE IF NOT EXISTS horizontal_scalings (id bigint PRIMARY KEY DEFAULT next_id_v1('hs_id_seq'),
                                                                              scale_type text, state text, metadata JSONB,
                                                                                                                    spec JSONB,
                                                                                                                         status JSONB,
                                                                                                                                object_meta JSONB,
                                                                                                                                            type_meta JSONB,
...
CREATE OR REPLACE FUNCTION insert_hs_v1 (scale_type text, state text, metadata JSONB, spec JSONB, status JSONB, object_meta JSONB, type_meta JSONB) RETURNS
...
CREATE OR REPLACE FUNCTION get_horizontal_scaling_v1(hid bigint) RETURNS
SETOF horizontal_scalings AS $$
                                                                                                                                                                                               BEGIN
...
CREATE OR REPLACE FUNCTION get_hs_v1() RETURNS
SETOF horizontal_scalings AS $$
                  BEGIN
...
CREATE OR REPLACE FUNCTION update_hs_v1 (hid bigint, hs_scale_type text, hs_state text, hs_metadata JSONB, hs_spec JSONB, hs_status JSONB, hs_object_meta JSONB) RETURNS
SETOF horizontal_scalings AS $$
                      BEGIN
...
CREATE TABLE IF NOT EXISTS vertical_scalings (id bigint PRIMARY KEY DEFAULT next_id_v1('vs_id_seq'),
                                                                            scale_type text, state text, update_policy JSONB,
                                                                                                                       metadata JSONB,
                                                                                                                                spec JSONB,
                                                                                                                                     status JSONB,
                                                                                                                                            object_meta JSONB,
...
CREATE OR REPLACE FUNCTION insert_vs_v1 (scale_type text, state text, update_policy JSONB, metadata JSONB, spec JSONB, status JSONB, object_meta JSONB, type_meta JSONB) RETURNS
SETOF vertical_scalings AS $$
                          BEGIN
...
CREATE OR REPLACE FUNCTION get_vs_v1() RETURNS
SETOF vertical_scalings AS $$
                  BEGIN
...
CREATE OR REPLACE FUNCTION set_vs_status_v1 (vid bigint, hs_status JSONB) RETURNS
SETOF vertical_scalings AS $$
                      BEGIN
...
CREATE OR REPLACE FUNCTION get_vertical_scaling_v1(vid bigint) RETURNS
SETOF vertical_scalings AS $$
                  BEGIN
...
CREATE OR REPLACE FUNCTION update_vs_v1 (vid bigint, vs_scale_type text, vs_state text, vs_update_policy JSONB, vs_metadata JSONB, vs_spec JSONB, vs_status JSONB, vs_object_meta JSONB) RETURNS
SETOF vertical_scalings AS $$
                      BEGIN
