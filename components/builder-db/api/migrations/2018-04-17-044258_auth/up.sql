...
CREATE TABLE IF NOT EXISTS teams (id bigint UNIQUE PRIMARY KEY DEFAULT next_id_v1('team_id_seq'),
                                                                       name text UNIQUE,
                                                                                 type_meta JSONB,
                                                                                           object_meta JSONB,
                                                                                                       meta_data JSONB,
...
CREATE OR REPLACE FUNCTION insert_team_v1 (team_name text, origin text, team_object_meta JSONB, team_type_meta JSONB, team_meta_data JSONB, team_mem_type_meta JSONB) RETURNS
SETOF teams AS $$
               DECLARE
...
WITH first_insert AS
  (INSERT INTO roles(name, description)
   VALUES('rioos:superuser',
          'Superuser of RIO/OS. God given powers.  instance') ON CONFLICT (name) DO NOTHING RETURNING id)
INSERT INTO permissions (role_id, name, description)
VALUES 
    ((SELECT id FROM first_insert), 'rioos.*.*','Allow any access to all resources.');

WITH first_insert AS
  (INSERT INTO roles(name, description)
   VALUES('rioos:universalsoldier',
          'Universalsoldier is system level user (like service account). instance') ON CONFLICT (name) DO NOTHING RETURNING id)
INSERT INTO permissions (role_id, name, description)
VALUES 
    ((SELECT id FROM first_insert), 'rioos.assembly.get','Read only access for assembly resource.'),
    ((SELECT id FROM first_insert), 'rioos.assembly.put','Edit only access for assembly resource.'),
    ((SELECT id FROM first_insert), 'rioos.assembly.delete','Delete access for assembly resource.'),
    ((SELECT id FROM first_insert), 'rioos.assemblyfactory.get','Read only access for assemblyfactory resource.'),
    ((SELECT id FROM first_insert), 'rioos.assemblyfactory.put','Edit only access for assemblyfactory resource.'),
    ((SELECT id FROM first_insert), 'rioos.assemblyfactory.delete','Delete access for assemblyfactory resource.'),
    ((SELECT id FROM first_insert), 'rioos.serviceaccount.put','Edit only access for service account resource.'),
    ((SELECT id FROM first_insert), 'rioos.serviceaccount.delete','Delete access for service account resource.'),
    ((SELECT id FROM first_insert), 'rioos.horizontalscaling.get','Read only access for horizontalscaling resource.'),
    ((SELECT id FROM first_insert), 'rioos.horizontalscaling.put','Edit only access for horizontalscaling resource.'),
    ((SELECT id FROM first_insert), 'rioos.verticalscaling.get','Read only access for verticalscaling resource.'),
    ((SELECT id FROM first_insert), 'rioos.verticalscaling.put','Edit only access for verticalscaling resource.'),
    ((SELECT id FROM first_insert), 'rioos.secret.*','Any access allowed for this secrets resource.'),
    ((SELECT id FROM first_insert), 'rioos.endpoint.*','Any access allowed for this endpoints resource.'),
    ((SELECT id FROM first_insert), 'rioos.job.*','Any access allowed for this jobs resource.'),
    ((SELECT id FROM first_insert), 'rioos.service.*','Any access allowed for this service resource.'),
    ((SELECT id FROM first_insert), 'rioos.volume.*','Any access allowed for this volumes resource.'),
    ((SELECT id FROM first_insert), 'rioos.node.*','Any access allowed for this nodes resource.'),
    ((SELECT id FROM first_insert), 'rioos.storageconnector.*','Any access allowed for this storage connectors resource.'),
    ((SELECT id FROM first_insert), 'rioos.storagepool.*','Any access allowed for this storage pool resource.'),
    ((SELECT id FROM first_insert), 'rioos.settingsmap.*','Any access allowed for this settings map resource.'),
    ((SELECT id FROM first_insert), 'rioos.imagereference.*','Any access allowed for this image reference resource.'),
    ((SELECT id FROM first_insert), 'rioos.imagemark.*','Any access allowed for this image mark resource.'),
    ((SELECT id FROM first_insert), 'rioos.build.*','Any access allowed for this build resource.'),
    ((SELECT id FROM first_insert), 'rioos.buildconfig.get','Read only access for buildconfig resource.'),
    ((SELECT id FROM first_insert), 'rioos.buildconfig.put','Edit only access for buildconfig resource.'),
    ((SELECT id FROM first_insert), 'rioos.plan.get','Read only access for plans resource.'),
    ((SELECT id FROM first_insert), 'rioos.plan.put','Edit only access for plans resource.'),
    ((SELECT id FROM first_insert), 'rioos.account.get','Read only access for accounts resource.'),
    ((SELECT id FROM first_insert), 'rioos.datacenter.get','Read only access for datacenters resource.'),
    ((SELECT id FROM first_insert), 'rioos.datacenter.put','Edit only access for datacenters resource.'),
    ((SELECT id FROM first_insert), 'rioos.network.get','Read only access for networks resource.'),
    ((SELECT id FROM first_insert), 'rioos.network.put','Edit only access for networks resource.'),
    ((SELECT id FROM first_insert), 'rioos.audit.post','create access allowed for networks resource.');


WITH second_insert AS
  (INSERT INTO roles(name, description)
   VALUES('rioos:loneranger',
          'This is a regular  user ') ON CONFLICT (name) DO NOTHING RETURNING id)
INSERT INTO permissions (role_id, name, description)
VALUES 
    ((SELECT id FROM second_insert), 'rioos.assembly.put','Edit only access for assembly resource.'),
    ((SELECT id FROM second_insert), 'rioos.assembly.get','Read only access for assembly resource.'),
    ((SELECT id FROM second_insert), 'rioos.assemblyfactory.*','Any access allowed for this assemblyfactory resource.'),
    ((SELECT id FROM second_insert), 'rioos.horizontalscaling.*','Any access allowed for this horizontalscaling resource.'),
    ((SELECT id FROM second_insert), 'rioos.verticalscaling.*','Any access allowed for this verticalscaling resource.'),
    ((SELECT id FROM second_insert), 'rioos.secret.*','Any access allowed for this secrets resource.'),
    ((SELECT id FROM second_insert), 'rioos.endpoint.*','Any access allowed for this endpoints resource.'),
    ((SELECT id FROM second_insert), 'rioos.service.*','Any access allowed for this service resource.'),
    ((SELECT id FROM second_insert), 'rioos.buildconfig.*','Any access allowed for this buildconfig resource.'),
    ((SELECT id FROM second_insert), 'rioos.log.get','Read only access for logs resource.'),
    ((SELECT id FROM second_insert), 'rioos.audit.get','Read only access for audits resource.'),
    ((SELECT id FROM second_insert), 'rioos.volume.get','Read only access for volumes resource.'),
    ((SELECT id FROM second_insert), 'rioos.account.get','Read only access for accounts resource.'),
    ((SELECT id FROM second_insert), 'rioos.account.put','Edit only access for accounts resource.'),
    ((SELECT id FROM second_insert), 'rioos.datacenter.get','Read only access for datacenters resource.'),
    ((SELECT id FROM second_insert), 'rioos.healthz.get','Read only access for healthz resource.'),
    ((SELECT id FROM second_insert), 'rioos.plan.get','Read only access for plan resource.'),
    ((SELECT id FROM second_insert), 'rioos.network.get','Read only access for networks resource.');
