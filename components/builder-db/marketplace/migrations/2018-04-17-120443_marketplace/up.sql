...
CREATE OR REPLACE FUNCTION insert_marketplace_v1 (type_meta JSONB, object_meta JSONB, plans JSONB) RETURNS
SETOF marketplaces AS $$
                  BEGIN
                    RETURN QUERY INSERT INTO marketplaces(type_meta, object_meta, plans)
                      VALUES (type_meta, object_meta, plans)
                      RETURNING *;
                    RETURN;
                  END
