...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let msg = match *self {
            ...
            Error::BuildConfigCreate(ref e) => format!("Database error creating a build config, {}", e),
            Error::BuildConfigGet(ref e) => format!("Database error get the build config, {}", e),
            Error::BuildConfigGetResponse(ref e) => format!("Database error list build config, {}", e),
            ...
            Error::ImageRefUpdate(ref e) => format!("Database error update image references , {}", e),
            ...
            Error::BuildStatusUpdate(ref e) => format!("Database error status update build , {}", e),
