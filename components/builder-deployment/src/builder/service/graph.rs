...
impl ServiceGraph {
    ...
    pub fn extend(&mut self, service: &linker::Services) -> (usize, usize) {
        ...
        let _add_deps = if self.latest_map.contains_key(short_name) {
            let skip_update = {
    ...
    pub fn _latest(&self) -> Vec<String> {
    ...
    pub fn _resolve(&self, name: &str) -> Option<String> {
