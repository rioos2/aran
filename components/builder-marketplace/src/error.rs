...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let msg = match *self {
            ...
            Error::MarketPlaceCreate(ref e) => format!("Database error creating a marketplace, {}", e),
            Error::MarketPlaceGet(ref e) => format!("Database error getting marketplace  data, {}", e),
